...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_milestones_resolution_id'), 'milestones', ['resolution_id'], unique=False)
    ...
    op.create_index(op.f('ix_progress_logs_resolution_id'), 'progress_logs', ['resolution_id'], unique=False)

    op.create_table('verification_quizzes',
        sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_verification_quizzes_id'), 'verification_quizzes', ['id'], unique=False)
    op.create_index(op.f('ix_verification_quizzes_progress_log_id'), 'verification_quizzes', ['progress_log_id'], unique=True)
    ...
    op.create_index(op.f('ix_streaks_resolution_id'), 'streaks', ['resolution_id'], unique=True)
    ...
    op.create_index(op.f('ix_weekly_reflections_id'), 'weekly_reflections', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_verification_quizzes_progress_log_id'), table_name='verification_quizzes')
